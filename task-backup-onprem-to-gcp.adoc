...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["3つ"] コネクタのネットワークの準備
[role="quick-margin-para"]
コネクタに必要なネットワーク接続があることを確認します。

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["4."] ライセンス要件を確認
[role="quick-margin-para"]
Google CloudとBlueXPの両方のライセンス要件を確認する必要があります。

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["5 つ"] ONTAPクラスタを準備
[role="quick-margin-para"]
