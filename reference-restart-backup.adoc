...
| クラウドの導入 | の手順に従ってください https://docs.netapp.com/us-en/bluexp-setup-admin/task-managing-connectors.html#connect-to-the-linux-vm["コネクタLinux仮想マシンに接続しています"^] 使用しているクラウドプロバイダによって異なります。 
