...
コネクタの要件:: このコネクタは、インターネットアクセスがフルまたは制限されたAWSリージョン（「標準」または「制限」モード）にインストールできます。
+
--
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-connector-onprem-no-internet.html["AWSリージョンのLinuxホストへのコネクタの手動インストール"^]
