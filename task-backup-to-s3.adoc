...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-aws.html["AWSにコネクタを導入します"^]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-restricted-mode.html["AWSリージョンのLinuxホストへのコネクタの手動インストール"^]
