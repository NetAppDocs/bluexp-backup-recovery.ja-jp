...
+
--
* KubernetesクラスタがBlueXP作業環境として検出されました。 https://docs.netapp.com/us-en/cloud-manager-kubernetes/task/task-kubernetes-discover-gke.html["Kubernetes クラスタの検出方法を参照してください"^]。
